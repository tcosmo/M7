...
QString VerovioEngine::renderAllPagesHtml() const
{
    ...
    html += QStringLiteral("\n"
        ...
        "  _cursorEl.style.display = _cursorVisible ? 'block' : 'none';\n"
        "}\n"
        "var _cursorX = 0;\n"
        "var _cursorSysTop = 0;\n"
        ...
        "function hideCursor() { _cursorVisible = false; if (_cursorEl) _cursorEl.style.display='none'; }\n"
        "function showCursor() { _cursorVisible = true; }\n"
        "var _clickedNoteId = '';\n"
